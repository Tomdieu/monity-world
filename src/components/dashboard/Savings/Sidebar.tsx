...
function SavingsSidebar({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-base text-neutral-600 font-semibold">Savings</h2>
      </div>
      ...
      <nav className="grid gap-2">
        {sidebarLinks.map(({ href, label, icon }) => {
          const isActiveLink = (url: string) => {
            ...
            if (url === "/dashboard/savings") {
              return pathname === "/dashboard/savings";
            }
