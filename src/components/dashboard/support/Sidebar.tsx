...
function SupportSidebar({ className }: { className?: string }) {
  ...
  const sidebarLinks: SidebarLink[] = [
    ...
    {
      href: "/dashboard/support/faq-and-resources",
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-base text-neutral-600 font-semibold">Support</h2>
      </div>
