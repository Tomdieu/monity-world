...
function KycUserDetail() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-3 w-full px-5 overflow-y-scroll pb-11 py-2 relative">
      ...
      <div className="flex flex-col gap-4 flex-1 overflow-y-auto">
        ...
        <Tabs defaultValue="timeline" className="flex flex-col gap-2">
          <TabsList className="flex items-center justify-start bg-transparent gap-2">
            <TabsTrigger
              value="timeline"
              className="flex p-3 gap-2 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow"
            >
              <span>Timeline</span>
            ...
            <TabsTrigger
              ...
              className="flex p-3 gap-2 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow"
            >
              <span>Files</span> <PiFilesLight className="size-4" />
            </TabsTrigger>
          </TabsList>
